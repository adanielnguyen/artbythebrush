...
user1 = User.create!(email: "henry", password:"password")
...
artwork3.image.attach(io: file, filename: 'nes.png', content_type: 'image/png')
artwork3.save!
...
artwork4.image.attach(io: file, filename: 'nes.png', content_type: 'image/png')
artwork4.save!